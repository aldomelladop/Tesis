...
#  
df1 = fixrows(dir_pot+'Potencia_r1').iloc([:20000,:])
...
# 
df2 = fixrows(dir_pot+'Potencia_r2').iloc([:20000,:])
...
df3 = fixrows(dir_pot+'Potencia_r3').iloc([:20000,:])
...
df4 = fixrows(dir_pot+'Potencia_r4').iloc([:20000,:])
