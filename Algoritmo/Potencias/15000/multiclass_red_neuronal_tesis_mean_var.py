...
#  
df1 = fixrows( 'Potencia_r1').iloc[:15000,:]
...
# 
df2 = fixrows( 'Potencia_r2').iloc[:15000,:]
...
df3 = fixrows( 'Potencia_r3').iloc[:15000,:]
...
df4 = fixrows( 'Potencia_r4').iloc[:15000,:]
...
classifier = KerasClassifier(build_fn = build_classifier, batch_size = 32, epochs = 20)
