# -*- coding: utf-8 -*-
"""multiclass_red_neuronal_tesis_4.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1NIxZBHtvvtkQczVwAhhvJcTkJIENS5HP
"""
...
# =============================================================================
a = list(product([30,1000,5000,10000,15000],['s','n']))
...
f.write("El número de elementos usados es: {}\n".format(j)+
        ...
        "\nLas means obtenidas son: {}".format(means) +
        "\nLas stds obtenida es: {}".format(stds) + '\n'
        )
for i in ac:
