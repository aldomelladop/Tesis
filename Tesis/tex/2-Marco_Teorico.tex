...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            ...
            \begin{itemize}
                ...
                \begin{itemize}
                    ...
                    \item {\textbf{Alto Bias}: Los valores predichos son cercanos a los valores reales y la red debe hacer un mayor trabajo con los datos a fin de extraer las características que le permitan llegar al resultado.}
